...
- Authentication can use GEMINI_API_KEY / GOOGLE_API_KEY or local Gemini CLI login (run \`gemini auth login\` to authenticate with your Google/Gemini Ultra subscription).
`;
